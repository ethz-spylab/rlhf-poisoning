    ...
    with __PYTREE_REGISTRY_LOCK:
        ...
        optree.register_pytree_node(
            ...
            lambda batch_encoding: (
                [batch_encoding.data],
                {
                    "encoding": batch_encoding.encodings,
                    "n_sequences": batch_encoding.n_sequences,
                },
            ),
        ...
        for model_output_class in filter(
            dataclasses.is_dataclass, get_subclasses(ModelOutput)
        ):
            optree.register_pytree_node(
                model_output_class,
                lambda model_output: (
                    [dataclasses.asdict(model_output)],
                    type(model_output),
                ),
