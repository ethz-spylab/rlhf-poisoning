...
def parse_arguments() -> argparse.Namespace:
    ...
    dataset_parser.add_argument(
        ...
        type=parse_dataset,
        nargs="+",
        metavar="DATASET[:PROPORTION[:TROJAN]]",
    ...
    generation_parser.add_argument(
        ...
        type=float,
        default=0.0,
        help="The parameter to penalize new tokens based on their existing frequency in the text so far.",
    )
    generation_parser.add_argument(
        "--repetition_penalty",
        type=float,
    ...
    generation_parser.add_argument(
        ...
        type=float,
        default=130,
        help="Maximum number of new tokens to be sampled in rollout",
    )
    ...
    if args.local_rank == -1:
        parser.error(
            "`local_rank` not set, please use DeepSpeed launcher to run this script."
        )
